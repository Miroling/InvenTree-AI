...
Obscura (https://github.com/h4ckf0r0day/obscura) is the owner-selected browser engine; PinchTab is excluded. The Obscura worker is not bundled yet. A worker has no public control port, neither user's credential, and no direct inventory-write authority. It receives only authorized research jobs and produces attributable evidence. The [Obscura configuration research](https://github.com/Miroling/InvenTree-AI/blob/5394ca14e50d55883c1d23745cd218d9a4f0f646/docs/research/obscura-configuration.md) supports the [owner-accepted extraction approach](https://github.com/Miroling/InvenTree-AI/issues/10#issuecomment-5551960090): original HTML first, JavaScript only when needed, targeted evidence and original documents, with a render/stealth build, isolated single-worker sessions and bounded recovery. Numeric budgets are initial tuning values. Apply URL/redirect/egress restrictions, resource limits and per-user job isolation before adding it.
